...
export interface ApiArchiveArchive extends Schema.CollectionType {
  ...
  attributes: {
    ...
    description: Attribute.Component<'array.long-text', true>;
    skills: Attribute.Component<'array.array', true>;
    githubLink: Attribute.String;
    liveProjectLink: Attribute.String;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiExperienceExperience extends Schema.CollectionType {
  ...
  attributes: {
    ...
    timeline: Attribute.String;
    link: Attribute.String;
    descriptionOf: Attribute.Component<'array.long-text', true>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiFeatureFeature extends Schema.CollectionType {
  ...
  attributes: {
    ...
    backgroundUrl: Attribute.String;
    modal: Attribute.String;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiHeroHero extends Schema.SingleType {
  ...
  attributes: {
    ...
    description: Attribute.Text;
    heading: Attribute.Component<'array.array', true>;
...
export interface ApiMyAssetMyAsset extends Schema.SingleType {
  collectionName: 'my_assets';
  info: {
    singularName: 'my-asset';
    pluralName: 'my-assets';
    displayName: 'MyAsset';
    description: '';
  };
  options: {
  ...
  attributes: {
    ...
    lightLogo: Attribute.Media;
    resume: Attribute.Media;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::my-asset.my-asset',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiSkillSkill extends Schema.CollectionType {
  ...
  attributes: {
    ...
    skillList: Attribute.Component<'array.array', true>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::my-asset.my-asset': ApiMyAssetMyAsset;
